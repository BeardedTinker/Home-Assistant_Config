...
class ZipFile:
    ...
    def remove(self, member):
        ...
        _LOGGER.debug("Remove self: %s", self.fp)
        _LOGGER.debug("Remove self filelist: %s", self.filelist)
        _LOGGER.debug("Remove member: %s", member)
        ...
        _LOGGER.debug("Remove memberzifo: %s", zinfo)
    ...
    def _remove_member(self, member):
        ...
        _LOGGER.debug("Remove member filelist: %s", self.filelist)
