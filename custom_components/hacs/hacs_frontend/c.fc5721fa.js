import{_ as i,H as s,e as t,p as e,d as a,r as o,ap as r,as as l,at as n,n as c}from"./main-50818363.js";import"./c.deb7549b.js";import"./c.1017879c.js";import"./c.9f27b448.js";import"./c.0a038163.js";let h=i([c("hacs-removed-dialog")],(function(i,s){return{F:class extends s{constructor(...s){super(...s),i(this)}},d:[{kind:"field",decorators:[t({attribute:!1})],key:"repository",value:void 0},{kind:"field",decorators:[t({type:Boolean})],key:"_updating",value:()=>!1},{kind:"method",key:"render",value:function(){if(!this.active)return e``;const i=this.hacs.removed.find(i=>i.repository===this.repository.full_name);return e`
      <hacs-dialog
        .active=${this.active}
        .hass=${this.hass}
