import{a as o,H as s,e as t,t as i,$ as a,W as e,X as r,Y as c,Z as d,s as n,d as h,r as l,n as p}from"./main-c486ac4b.js";import{a as m}from"./c.0a038163.js";import"./c.7a8a1642.js";import"./c.c6de3a6a.js";import"./c.dbf1e460.js";import"./c.8518b2d7.js";import"./c.a1b0d976.js";import"./c.9f27b448.js";import"./c.45eb8a3e.js";import"./c.aa656dcc.js";import"./c.84013a61.js";import"./c.aeac0a64.js";import"./c.5c703026.js";import"./c.ac45ea7a.js";import"./c.f23b59f3.js";let u=o([p("hacs-custom-repositories-dialog")],(function(o,s){return{F:class extends s{constructor(...s){super(...s),o(this)}},d:[{kind:"field",decorators:[t()],key:"_error",value:void 0},{kind:"field",decorators:[i()],key:"_progress",value:()=>!1},{kind:"field",decorators:[i()],key:"_addRepositoryData",value:()=>({category:void 0,repository:void 0})},{kind:"field",decorators:[i()],key:"_customRepositories",value:void 0},{kind:"method",key:"shouldUpdate",value:function(o){return o.has("narrow")||o.has("active")||o.has("_error")||o.has("_addRepositoryData")||o.has("_customRepositories")||o.has("_progress")}},{kind:"method",key:"render",value:function(){var o,s;if(!this.active)return a``;const t=[{type:"string",name:"repository"},{type:"select",name:"category",optional:!0,options:this.hacs.configuration.categories.map((o=>[o,this.hacs.localize(`common.${o}`)]))}];return a`
      <hacs-dialog
        .active=${this.active}
        .hass=${this.hass}
      ...
      >
        <div class="content">
          <div class="list" ?narrow=${this.narrow}>
            ...
            ${null===(s=this._customRepositories)||void 0===s?void 0:s.filter((o=>this.hacs.configuration.categories.includes(o.category))).map((o=>a`<ha-settings-row
