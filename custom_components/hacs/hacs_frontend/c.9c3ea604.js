import{Q as t,S as e,P as i,U as a,a as s,h as o,$ as r,G as n,r as l,n as d,x as c,e as h,a5 as p,t as m,I as u,J as _,m as g,A as b,ec as f,i as v,o as y,cp as w,aZ as x,ed as k,O as $,w as z,aQ as C,ee as I,ef as O,z as S,L as E}from"./main-4ba31b39.js";import{a as T}from"./c.4a97632a.js";import"./c.e87e0f42.js";import{r as L,t as M}from"./c.45a36679.js";import{c as R}from"./c.5765317e.js";import{grid as A}from"@lit-labs/virtualizer/layouts/grid";import"./c.89ef936d.js";import"./c.76fdbf25.js";import{d as j}from"./c.0f42cc4f.js";import{t as D,c as P,U as V,M as N,g as H,B as U,b as B,i as F,d as W}from"./c.b08e0eac.js";import{a as q}from"./c.93a5d34c.js";import{b as G,e as K}from"./c.be11274c.js";import"./c.bfd1c366.js";import"./c.c0a51ebe.js";import"./c.c3ec9280.js";import"./c.f4f8169c.js";import{a as Y}from"./c.9c584e29.js";const J=(t,e)=>{var i,a;const s=t._$AN;if(void 0===s)return!1;for(const t of s)null===(a=(i=t)._$AO)||void 0===a||a.call(i,e,!1),J(t,e);return!0},Q=t=>{let e,i;do{if(void 0===(e=t._$AM))break;i=e._$AN,i.delete(t),t=e}while(0===(null==i?void 0:i.size))},X=t=>{for(let e;e=t._$AM;t=e){let i=e._$AN;if(void 0===i)e._$AN=i=new Set;else if(i.has(t))break;i.add(t),et(e)}};function Z(t){void 0!==this._$AN?(Q(this),this._$AM=t,X(this)):this._$AM=t}function tt(t,e=!1,i=0){const a=this._$AH,s=this._$AN;if(void 0!==s&&0!==s.size)if(e)if(Array.isArray(a))for(let t=i;t<a.length;t++)J(a[t],!1),Q(a[t]);else null!=a&&(J(a,!1),Q(a));else J(this,t)}const et=t=>{var i,a,s,o;t.type==e.CHILD&&(null!==(i=(s=t)._$AP)&&void 0!==i||(s._$AP=tt),null!==(a=(o=t)._$AQ)&&void 0!==a||(o._$AQ=Z))};class it extends t{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),X(this),this.isConnected=t._$AU}_$AO(t,e=!0){var i,a;t!==this.isConnected&&(this.isConnected=t,t?null===(i=this.reconnected)||void 0===i||i.call(this):null===(a=this.disconnected)||void 0===a||a.call(this)),e&&(J(this,t),Q(this))}setValue(t){if(L(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}class at{constructor(t){this.U=t}disconnect(){this.U=void 0}reconnect(t){this.U=t}deref(){return this.U}}class st{constructor(){this.Y=void 0,this.q=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.q=t)))}resume(){var t;null===(t=this.q)||void 0===t||t.call(this),this.Y=this.q=void 0}}const ot=t=>!M(t)&&"function"==typeof t.then;const rt=i(class extends it{constructor(){super(...arguments),this._$Cft=1073741823,this._$Cwt=[],this._$CG=new at(this),this._$CK=new st}render(...t){var e;return null!==(e=t.find((t=>!ot(t))))&&void 0!==e?e:a}update(t,e){const i=this._$Cwt;let s=i.length;this._$Cwt=e;const o=this._$CG,r=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cft);t++){const a=e[t];if(!ot(a))return this._$Cft=t,a;t<s&&a===i[t]||(this._$Cft=1073741823,s=0,Promise.resolve(a).then((async t=>{for(;r.get();)await r.get();const e=o.deref();if(void 0!==e){const i=e._$Cwt.indexOf(a);i>-1&&i<e._$Cft&&(e._$Cft=i,e.setValue(t))}})))}return a}disconnected(){this._$CG.disconnect(),this._$CK.pause()}reconnected(){this._$CG.reconnect(this),this._$CK.resume()}});let nt,lt;async function dt(){return lt||async function(){if(nt)return(await nt).default;nt=window.ResizeObserver;try{new nt((function(){}))}catch(t){nt=import("./c.24bd2446.js"),nt=(await nt).default}return lt=nt}()}s([d("ha-header-bar")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"method",key:"render",value:function(){return r`<header class="mdc-top-app-bar">
    ...
    `:r``}},{kind:"method",key:"_manage",value:function(){var t,e;t=this,e={currentItem:this.currentItem,onClose:()=>b(this,"media-refresh")},b(t,"show-dialog",{dialogTag:"dialog-media-manage",dialogImport:()=>import("./c.9f6f13b7.js"),dialogParams:e})}},{kind:"field",static:!0,key:"styles",value:()=>l`
    mwc-button {
  ...
  `}]}}),o),s([d("dialog-media-player-browse")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[h({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[m()],key:"_currentItem",value:void 0},{kind:"field",decorators:[m()],key:"_navigateIds",value:void 0},{kind:"field",decorators:[m()],key:"_params",value:void 0},{kind:"field",decorators:[v("ha-media-player-browse")],key:"_browser",value:void 0},{kind:"method",key:"showDialog",value:function(t){this._params=t,this._navigateIds=t.navigateIds||[{media_content_id:void 0,media_content_type:void 0}]}},{kind:"method",key:"closeDialog",value:function(){this._params=void 0,this._navigateIds=void 0,this._currentItem=void 0,b(this,"dialog-closed",{dialog:this.localName})}},{kind:"method",key:"render",value:function(){return this._params&&this._navigateIds?r`
    ...
    `:r``}},{kind:"method",key:"_goBack",value:function(){var t;this._navigateIds=null===(t=this._navigateIds)||void 0===t?void 0:t.slice(0,-1),this._currentItem=void 0}},{kind:"method",key:"_mediaBrowsed",value:function(t){this._navigateIds=t.detail.ids,this._currentItem=t.detail.current}},{kind:"method",key:"_mediaPicked",value:function(t){this._params.mediaPickedCallback(t.detail),"play"!==this._action&&this.closeDialog()}},{kind:"get",key:"_action",value:function(){return this._params.action||"play"}},{kind:"method",key:"_refreshMedia",value:function(){this._browser.refresh()}},{kind:"get",static:!0,key:"styles",value:function(){return[E,l`
      ...
      `]}}]}}),o);var St=Object.freeze({__proto__:null});export{St as a,yt as b,it as d,wt as i,kt as r,xt as u};
