import{a as i,H as s,e as t,$ as e,d as a,r as o,at as r,au as l,aq as n,av as c,aw as h,n as d}from"./main-4ba31b39.js";import"./c.f98698a2.js";import"./c.e87e0f42.js";import"./c.8e28b461.js";let u=i([d("hacs-removed-dialog")],(function(i,s){return{F:class extends s{constructor(...s){super(...s),i(this)}},d:[{kind:"field",decorators:[t({attribute:!1})],key:"repository",value:void 0},{kind:"field",decorators:[t({type:Boolean})],key:"_updating",value:()=>!1},{kind:"method",key:"render",value:function(){if(!this.active)return e``;const i=this.hacs.removed.find((i=>i.repository===this.repository.full_name));return e`
      <hacs-dialog
        .active=${this.active}
        .hass=${this.hass}
