import{_ as i,H as s,e as t,$ as e,d as a,r as o,av as r,aw as l,as as n,ax as c,ay as h,n as d}from"./main-def8a0ab.js";import"./c.7bb784b9.js";import"./c.e0d43491.js";import"./c.9f27b448.js";import"./c.0a038163.js";let u=i([d("hacs-removed-dialog")],(function(i,s){return{F:class extends s{constructor(...s){super(...s),i(this)}},d:[{kind:"field",decorators:[t({attribute:!1})],key:"repository",value:void 0},{kind:"field",decorators:[t({type:Boolean})],key:"_updating",value:()=>!1},{kind:"method",key:"render",value:function(){if(!this.active)return e``;const i=this.hacs.removed.find(i=>i.repository===this.repository.full_name);return e`
      <hacs-dialog
        .active=${this.active}
        .hass=${this.hass}
