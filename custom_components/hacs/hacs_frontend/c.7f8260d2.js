      ...
      >
        <div class="searchandfilter" ?narrow=${this.narrow}>
          ...
          <mwc-select
            ...
            @closed=${u}
          >
            ${f.map(e=>r`<mwc-list-item .value=${e}>
                  ${this.hacs.localize("store."+e)}
                </mwc-list-item>`)}
          </mwc-select>
        </div>
