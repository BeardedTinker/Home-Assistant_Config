    ...
    >
      ...
      <ha-button-menu slot="filter-menu" corner="BOTTOM_START" multi>
        ...
        ${this.narrow?"":u`
          ...
          `}},downloads:{...Oe,title:this.hacs.localize("column.downloads"),hidden:e||!t.downloads,sortable:!0,direction:"downloads"===(null===(a=this.activeSort)||void 0===a?void 0:a.column)?this.activeSort.direction:null,width:"10%",template:e=>u`${e||"-"}`},stars:{...Oe,title:this.hacs.localize("column.stars"),hidden:e||!t.stars,sortable:!0,direction:"stars"===(null===(o=this.activeSort)||void 0===o?void 0:o.column)?this.activeSort.direction:null,width:"10%"},last_updated:{...Oe,title:this.hacs.localize("column.last_updated"),hidden:e||!t.last_updated,sortable:!0,direction:"last_updated"===(null===(s=this.activeSort)||void 0===s?void 0:s.column)?this.activeSort.direction:null,width:"15%",template:(e,t)=>{try{return be(new Date(e),this.hass.locale)}catch(e){return"-"}}},installed_version:{...Oe,title:this.hacs.localize("column.installed_version"),hidden:e||!t.installed_version,sortable:!0,direction:"installed_version"===(null===(l=this.activeSort)||void 0===l?void 0:l.column)?this.activeSort.direction:null,width:"10%",template:(e,t)=>t.installed?e:"-"},available_version:{...Oe,title:this.hacs.localize("column.available_version"),hidden:e||!t.available_version,sortable:!0,direction:"available_version"===(null===(r=this.activeSort)||void 0===r?void 0:r.column)?this.activeSort.direction:null,width:"10%",template:(e,t)=>t.installed?e:"-"},status:{...Oe,title:this.hacs.localize("column.status"),hidden:e||!t.status,sortable:!0,direction:"status"===(null===(n=this.activeSort)||void 0===n?void 0:n.column)?this.activeSort.direction:null,width:"10%",template:e=>["pending-restart","pending-upgrade"].includes(e)?this.hacs.localize(`repository_status.${e}`):"-"},category:{...Oe,title:this.hacs.localize("column.category"),hidden:e||!t.category,sortable:!0,direction:"category"===(null===(c=this.activeSort)||void 0===c?void 0:c.column)?this.activeSort.direction:null,width:"10%",template:e=>this.hacs.localize(`common.${e}`)},authors:Oe,description:Oe,domain:Oe,full_name:Oe,id:Oe,topics:Oe,actions:{title:"",width:this.narrow?void 0:"10%",type:"overflow-menu",template:(e,t)=>t.installed?u`
                <ha-icon-overflow-menu
                  .hass=${this.hass}
                  .items=${le(this,t)}
                  narrow
